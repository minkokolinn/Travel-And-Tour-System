    ...
    <div id="responsive_tbl" style="width: 70%; margin-left: 15%;"> 
      ...
      <div class="row">
        <div class="col-md-12 text-right">
            <a href="promotion_insert.php">
              <button type="button" class="btn btn-info">ADD NEW PROMOTION</button>
            </a>
        </div>
      </div>
      </div>
      ...
      <div style="overflow-x:auto;">
        <table>
          ...
          <?php 
                $selectpromotion="Select * from Promotion";
                $runselectpromotion=mysqli_query($connection,$selectpromotion);
                $countofpromotion=mysqli_num_rows($runselectpromotion);
                if ($countofpromotion>0) {
                  for ($i=0; $i <$countofpromotion ; $i++) { 
                    ...
                    echo "<tr>
                      ...
                      <td>
                      <a href='promotion_update.php?prid=$promotionid'>Update</a> 
                      | 
                      <a href='promotion_delete.php?prid=$promotionid'>Delete</a> 
                      </td>
                    </tr>
                    ";
                  }

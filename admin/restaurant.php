    ...
    <div id="responsive_tbl" style="width: 70%; margin-left: 15%;"> 
      ...
      <div class="row">
        <div class="col-md-12 text-right">
            <a href="restaurant_insert.php">
              <button type="button" class="btn btn-info">ADD NEW RESTAURANT</button>
            </a>
        </div>
      </div>
      </div>
                ...
                if ($countofrestaurant>0) {
                  for ($i=0; $i <$countofrestaurant ; $i++) { 
                    ...
                    echo "<tr>
                      ...
                      <td>
                      <a href='restaurant_detail.php?rid=$restaurantid'>Detail</a> 
                      |
                      <a href='restaurant_update.php?rid=$restaurantid'>Update</a> 
                      | 
                      <a href='restaurant_delete.php?rid=$restaurantid'>Delete</a> 
                      </td>
                    </tr>
                    ";
                  }

<?php 
    ...
    if (isset($_POST['btnpromotionadd'])) {
    $promotionname=$_POST['txtpromotionname'];
    $promotiondescription=$_POST['txtpromotiondescription'];

    $insertpromotion="INSERT into Promotion(promotionname,description) values
    ('$promotionname','$promotiondescription')";
    $runinsertpromotion=mysqli_query($connection,$insertpromotion);
    if ($runinsertpromotion) {
      echo "<script>window.alert('A new promotion information is added! Insert Query Successful!')</script>";
      echo "<script>window.location='promotion.php'</script>";
    }else{
        echo mysqli_error($connection);
        echo "<script>window.alert('Run insert promotion query failed!')</script>";
    }
  }
?>
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-0" data-aos="fade-up" data-aos-once="false">
            ...
            <form action="" class="p-5 bg-white" method="post">
              ...
              <center><h2 class="h4 text-black mb-3">Add New Promotion Type!</h2></center>

              <div class="row form-group">
                <div class="col-md-12 mb-0 mb-md-0">
                  <label class="text-black">Promotion Name</label>
                  <input type="text" class="form-control" name="txtpromotionname" required>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-0 mb-md-0">
                  ...
                  <textarea name="txtpromotiondescription" class="col-12" rows="5"></textarea>
                </div>
              </div>

              <div class="row form-group">
                <div class="col-md-4 col-3">
                  <input type="submit" value="Insert" class="button button-contactForm boxed-btn" name="btnpromotionadd">
                </div>

<?php 
 		include('../connect.php');
 		include('menu_inregister_admin.php');
    if (isset($_POST['btnstaffreg'])) {
    ...
    $stafftype=$_POST['cbstafftype'];
    $staffgender=$_POST['rbstaffgender'];
    $staffaddress=$_POST['txtstaffaddress'];

    $selectstaff="SELECT * from Staff where email='$staffemail'";
    $runselectstaff=mysqli_query($connection,$selectstaff);
    $countofstaff=mysqli_num_rows($runselectstaff);
    if ($countofstaff>0) {
      echo "<script>window.alert('Staff Account Is Already Existed!')</script>";
      echo "<script>window.location='staff_register.php'</script>";
    }else{
      if ($staffpass==$staffcpass) {
        $insertstaff="INSERT into Staff(staffname,phone,email,password,stafftype,gender,address) values
        ('$staffname','$staffphone','$staffemail','$staffcpass','$stafftype','$staffgender','$staffaddress')";
        $runinsertstaff=mysqli_query($connection,$insertstaff);
        if ($runinsertstaff) {
          echo "<script>window.alert('Staff Account Is Successfully Created!')</script>";
          echo "<script>window.location='staff_register.php'</script>";
        }else{
          echo mysqli_error($connection);
          echo "<script>window.alert('Run insert staff query failed!')</script>";
          echo "<script>window.location='staff_register.php'</script>";
        }
      }else{
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text text-center">
                        ...
                        <p>Please register your information! Make a perfect trip for your customer!</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-0" data-aos="fade-up" data-aos-once="false">
            ...
            <form action="" class="p-5 bg-white" method="post">
              ...
              <center><h2 class="h4 text-black mb-3">HEY STAFF! REGISTER HERE!</h2></center>
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-0 mb-md-0">
                  ...
                  <input type="text" class="form-control" name="txtstaffphone" required>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-0 mb-md-0">
                  ...
                  <input type="password" class="form-control" name="txtstaffcpass" required>
                </div>
              </div>

              <div class="row form-group">
                <div class="col-md-12 mb-0 mb-md-0">
                  <label class="text-black" for="stafftype">Staff Type</label>
                  <div class="row ml-1">
                    <select class="col-8" name="cbstafftype" required>
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-0 mb-md-0">
                  ...
                  <textarea name="txtstaffaddress" class="col-12" rows="4"></textarea>
                </div>
              </div>

              <div class="row form-group">
                <div class="col-md-4 col-3">
                  <input type="submit" value="Register" class="button button-contactForm boxed-btn" name="btnstaffreg">
                </div>
              ...
              <div class="row form-group">
                <div class="col-12">
                  <a href="staff_login.php"><p>Aready have an staff account?</p></a>
                </div>
              </div>
            </form>
          </div>

<?php 
    ...
    if (isset($_POST['btnaddpackagetype'])) {
    $packagetype=$_POST['txtpackagetype'];
    $typedescription=$_POST['txttypedescription'];
    ...
    if ($countofpackagetype>0) {
      echo "<script>window.alert('Package Type Is Already Existed!')</script>";
        ...
        $insertpackagetype="INSERT into PackageType(packagetype,typedescription) values
        ('$packagetype','$typedescription')";
        $runinsertpackagetype=mysqli_query($connection,$insertpackagetype);
        if ($runinsertpackagetype) {
          echo "<script>window.alert('A new package type information is added! Insert Query Successful!')</script>";
          echo "<script>window.location='package_type.php'</script>";
        }else{
          echo mysqli_error($connection);
          echo "<script>window.alert('Run insert package type query failed!')</script>";
        }
    }
  }
?>
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-0" data-aos="fade-up" data-aos-once="false">
            ...
            <form action="" class="p-5 bg-white" method="post">
              ...
              <center><h2 class="h4 text-black mb-3">Add New Package Type!</h2></center>

              <div class="row form-group">
                <div class="col-md-12 mb-0 mb-md-0">
                  <label class="text-black">Package Type</label>
                  <input type="text" class="form-control" name="txtpackagetype" required>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-0 mb-md-0">
                  ...
                  <textarea name="txttypedescription" class="col-12" rows="4"></textarea>
                </div>
              </div>

              <div class="row form-group">
                <div class="col-md-4 col-3">
                  <input type="submit" value="Insert" class="button button-contactForm boxed-btn" name="btnaddpackagetype">
                </div>

<?php 
    ...
    $feedback=$_POST['txtfeedback'];
        ...
        $insertfeedback="INSERT into Feedback(feedback,customerid) values
        ('$feedback','$customerid')";
        $runinsertfeedback=mysqli_query($connection,$insertfeedback);
        if ($runinsertfeedback) {
          echo "<script>window.alert('Feedback is successfully sent!')</script>";
        }else{
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-0" data-aos="fade-up" data-aos-once="false">
            ...
            <form action="" class="p-5 bg-white" method="post">
              ...
              <center><h2 class="h4 text-black mb-3">Give Feedback</h2></center>

              <div class="row form-group">
                <div class="col-md-12 mb-0 mb-md-0">
                  <label class="text-black">Feedback</label><br>
                  <textarea name="txtfeedback" class="col-12" rows="6"></textarea>
                </div>
              </div>

              <div class="row form-group">
                <div class="col-md-4 col-3">
                  <input type="submit" value="Submit" class="button button-contactForm boxed-btn" name="btnsubmitfeedback">
                </div>

                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li><a href="#">Service<i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
                                                        ...
                                                        <li><a href="service_detail.php">Service Detail</a></li>
                                                        <li><a href="travel_guide.php">Travel Guide</a></li>
                                                        <li><a href="travel_guide_manage.php">Manage Travel Guide</a></li>
                                                </ul>
                                            </li>
                                            <li><a class="" href="ticket.php">Ticket</a></li>
                                            <li><a href="#">Booking<i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
                                                        <li><a href="admin_view_booking_schedule.php">View Package Bookings</a></li>
                                                        <li><a href="admin_view_booking_ticket.php">View Ticket Booking</a></li>
                                                </ul>
                                            </li>

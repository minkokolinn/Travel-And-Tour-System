<?php 
    ...
    if (isset($_POST['btnsearchticket'])) {
      $selectedticketid=$_POST['cbsearchticket'];
    }
?>
        ...
        <div class="col-3 text-right ">
          <div class="row form-group">
            <select class="col-10" name='cbsearchticket'>
              <option value="">Choose Ticket ID</option>
              <?php 
                ...
                if ($countofticket>0) {
                  for ($i=0; $i <$countofticket ; $i++) { 
                    ...
                    $ticketid=$dataofticket['ticketid'];
    ...
    <div id="responsive_tbl" style="width: 90%; margin-left: 5%;"> 
      ...
      <div style="overflow-x:auto;">
        <table>
          ...
          <?php 
              if ($selectedticketid=="") {
                $selectticketbooking="Select bt.*,c.*,t.* from BookingTicket bt,Customer c,Ticket t where bt.customerid=c.customerid and bt.ticketid=t.ticketid";
                ...
                if ($countofbookingticket>0) {
                  for ($i=0; $i <$countofbookingticket ; $i++) { 
                    ...
                    $totalprice=$data['totalprice'];
                      ...
                      <td>$totalprice</td>
                      <td>
                      <a href='admin_delete_booking_ticket.php?avbtid=$bookingticketid'>Delete</a> 
                      </td>
                      </tr>
                      ";
                  }
                ...
                $selectticketbooking="Select bt.*,c.*,t.* from BookingTicket bt,Customer c,Ticket t where bt.customerid=c.customerid and bt.ticketid=t.ticketid and bt.ticketid='$selectedticketid'";
                $runselectticketbooking=mysqli_query($connection,$selectticketbooking);
                $countofbookingticket=mysqli_num_rows($runselectticketbooking);
                if ($countofbookingticket>0) {
                  for ($i=0; $i <$countofbookingticket ; $i++) { 

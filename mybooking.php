...
<body>
    ...
    <!-- ================ contact section end ================= -->
    <br><br>
    <center><h2>Package Bookings</h2></center>
    <div id="responsive_tbl" style="width: 97%; margin-left: 1.5%;"> 
      <br>
        ...
        <table>
          ...
          <?php 
              $selectbookingschedule="Select * from BookingSchedule bs,Customer c,Package p,Schedule s,Promotion pmt where bs.customerid=c.customerid and s.packageid=p.packageid and bs.scheduleid=s.scheduleid and bs.promotionid=pmt.promotionid and bs.customerid=$cid";
                ...
                if ($countofbookingschedule>0) {
                  ...
                  // echo "<center><h3>No Package Booking</h3></center>";
                }
            ?>
        </table>
      </div>
    ...
    <center><h2>Ticket Bookings</h2></center>
    <div id="responsive_tbl" style="width: 97%; margin-left: 1.5%;"> 
      <br>
      <div style="overflow-x:auto;">
        <table>
          ...
          <?php 
                $selectticketbooking="Select bt.*,c.*,t.* from BookingTicket bt,Customer c,Ticket t where bt.customerid=c.customerid and bt.ticketid=t.ticketid and bt.customerid=$cid";
                $runselectticketbooking=mysqli_query($connection,$selectticketbooking);
                $countofbookingticket=mysqli_num_rows($runselectticketbooking);
                if ($countofbookingticket>0) {
                  for ($i=0; $i <$countofbookingticket ; $i++) { 
                    $data=mysqli_fetch_array($runselectticketbooking);
                    $bookingticketid=$data['bookingticketid'];
                  ...
                  // echo "<center><h3>No Ticket Booking<h3></center>";
                }
            ?>
        </table>
      </div>

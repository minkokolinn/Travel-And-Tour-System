<?php 
    ...
    if (isset($_POST['btnaddservice'])) {
      ...
      $hotelid=$_POST['cbhotel'];
        ...
        $insertservice="INSERT into Service(packageid,restaurantid,hotelid) values
        ('$packageid','$restaurantid','$hotelid')";
        $runinsertservice=mysqli_query($connection,$insertservice);
        if ($runinsertservice){
          echo "<script>window.alert('A new service information is added! Insert Query Successful!')</script>";
          echo "<script>window.location='service_detail.php'</script>";
        }else{
          echo mysqli_error($connection);
          echo "<script>window.alert('Run insert service query failed!')</script>";
        }
  }
?>
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-0" data-aos="fade-up" data-aos-once="false">
            ...
            <form action="" class="p-5 bg-white" method="post" enctype="multipart/form-data">
              ...
              <center><h2 class="h4 text-black mb-3">Manage A New Service!</h2></center>
              ...
              <div class="row form-group">
                <div class="col-md-4 col-3">
                  <input type="submit" value="Finish" class="button button-contactForm boxed-btn" name="btnaddservice">
                </div>
